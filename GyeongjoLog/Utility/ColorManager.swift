...
struct ColorManager {
    ...
    static let darkGray01 = UIColor(named: "DarkGray-01")
    static let darkGray02 = UIColor(named: "DarkGray-02")
    static let lightGray01 = UIColor(named: "LightGary-01")
    ...
    // 텍스트 색상
    static let text01 = UIColor(named: "Text-01")
    static let text02 = UIColor(named: "Text-02")
    static let text03 = UIColor(named: "Text-03")
    static let textDisabled = UIColor(named: "Text-Disabled")
    
    // gradient 색상
    static let gradient01Start = UIColor(named: "Gradiant-01-Start")
    static let gradient01End = UIColor(named: "Gradiant-01-End")
    static let gradient02Start = UIColor(named: "Gradiant-02-Start")
    static let gradient02End = UIColor(named: "Gradiant-02-End")
}
